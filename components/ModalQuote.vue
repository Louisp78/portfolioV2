            ...
            <form class="flex flex-col gap-2">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  :placeholder="
                    t('quote.modal.placeholders.project-description')
                  "
                />
              </div>
            </form>
              ...
              <li v-for="(item, index) in [...itemList].reverse()" :key="index">
                <form class="flex flex-col gap-2 border rounded p-3">
                  ...
                  <textarea
                    ...
                    :placeholder="
                      t('quote.modal.placeholders.item-description')
                    "
                    :class="
